...
const Purchase = async ({ params }: { params: Promise<{ id: string }> }) => {
    ...
    return (
        <main id="purchase" className="">
            ...
            <p>
                Para adquirir el libro, completa el siguiente formulario con tus
                datos para habilitar la pasarela de pago. <br />
                El costo de envío no está incluido, el mismo se abona al momento
